...
class SectionSeeder extends Seeder
{
    ...
    public function run()
    {
         ...
         $sections = [            
            ['id' => 1, 'section_name' => 'SEÇÃO DE ARQUITETURA' ,  'coordinator_name' => 'MARIA'],
            ['id' => 2, 'section_name' => 'SEÇÃO DE INSTALAÇÃO' ,  'coordinator_name' => 'CELSO'],
            ['id' => 3, 'section_name' => 'SEÇÃO DE ORÇAMENTO' ,  'coordinator_name' => 'JADE'],
        ];
